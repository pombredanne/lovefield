...
/** @override */
olympia.db.schema.Database.prototype.getName = function() {
  return 'olympia';
};


/** @override */
olympia.db.schema.Database.prototype.getVersion = function() {
  return 1;
};


/** @override */
olympia.db.schema.Database.prototype.getTables = function() {
  return [
    this.medal_
  ];
};
...
olympia.db.schema.Medal = function() {
  ...
  var indices = [
    new lf.schema.Index('Medal', 'idx_year', false, ['year']),
    new lf.schema.Index('Medal', 'idx_lastName', false, ['lastName'])
  ];
